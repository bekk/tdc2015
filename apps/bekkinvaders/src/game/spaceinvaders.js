...
Game.prototype.moveToState = function(state) {
 ...
 Game.prototype.setX = function (newX) {
   this.newX = newX;
 };
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("BEKK Invaders", game.width / 2, game.height/2 - 40);
    ctx.font="16px Arial";

    ctx.fillText("Make a fist to start.", game.width / 2, game.height/2);
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="16px Arial";
    ctx.fillText("Make a fist to play again.", game.width / 2, game.height/2 + 40);
};
