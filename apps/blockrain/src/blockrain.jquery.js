...
window.BlockrainThemes = {
  ...
  'bekk': {
    background: '#262626',
    backgroundGrid: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAYAAAA7MK6iAAAANklEQVR42u3ToREAIBAEsS/mDN2jaQ40FTDzRKyO2kqyX1RgMBgM7gmPNa/A/WA7gcFg8B/wATnADuiT2ut9AAAAAElFTkSuQmCC',
    primary: '#ebebeb',
    secondary: '#df565b',
    stroke: '#262626',
    strokeWidth: 3,
